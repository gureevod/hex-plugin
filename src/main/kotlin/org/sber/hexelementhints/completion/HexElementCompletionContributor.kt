...
/**
 * Contributor для автодополнения с русскими названиями
 */
...
class HexElementCompletionProvider : CompletionProvider<CompletionParameters>() {
    ...
    override fun addCompletions(
        ...
        psiClass.allFields
            ...
            .forEach { field ->
                result.addElement(createLookupElement(field))
            }
    }
    ...
    private fun createLookupElement(field: PsiField): LookupElementBuilder {
        ...
        // Добавляем информацию о локаторе в второй строке (если есть)
